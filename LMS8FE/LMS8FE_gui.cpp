...
#include "LMS8FE_gui.h"

///////////////////////////////////////////////////////////////////////////

LMS8FE_view::LMS8FE_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, style)
{
	...
	// Connect Events
	this->Connect(wxEVT_CLOSE_WINDOW, wxCloseEventHandler(LMS8FE_view::OnClose_LMS8FE_view));
	mFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(LMS8FE_view::OnQuit), this, miQuit->GetId());
	mModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(LMS8FE_view::OnmiLMS8001), this, miLMS8001->GetId());
	rbI2C->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbI2CrbUSB), NULL, this);
	rbUSB->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbI2CrbUSB), NULL, this);
	btnRefreshPorts->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnRefreshPorts), NULL, this);
	btnOpenPort->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnOpenPort), NULL, this);
	btnClosePort->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnClosePort), NULL, this);
	btnOpen->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnOpen), NULL, this);
	btnSave->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSave), NULL, this);
	btnReset->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnReset), NULL, this);
	btnBoard2GUI->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnReadData), NULL, this);
	cmbChannel->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	pnlChannel->Connect(wxEVT_ERASE_BACKGROUND, wxEraseEventHandler(LMS8FE_view::OnEraseBackground_pnlChannel), NULL, this);
	cbBP_AMPX->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnSimpleChanged), NULL, this);
	...
	cbLMS8001_2_SSENn->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	cbEXT_PLL_SSENn->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	cbLMS8001_1_RESETn->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	...
	btnSC1905_Force_Update->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Force_Update), NULL, this);
	btnSC1905_Reset_RFPAL->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Reset_RFPAL), NULL, this);
	txtCtrlSC1905_RFIN_Offset->Connect(wxEVT_KILL_FOCUS, wxFocusEventHandler(LMS8FE_view::OnKillFocustxtCtrlSC1905_RFIN_Offset), NULL, this);
	txtCtrlSC1905_RFFB_Offset->Connect(wxEVT_KILL_FOCUS, wxFocusEventHandler(LMS8FE_view::OnKillFocustxtCtrlSC1905_RFFB_Offset), NULL, this);
	txtCtrlSC1905_RFFB_Offset->Connect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(LMS8FE_view::OntxtCtrlSC1905_RFFB_Offset), NULL, this);
	chSC1905_Frequency_Range->Connect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Frequency_Range), NULL, this);
	btnSC1905_Apply_Frequency->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Apply_Frequency), NULL, this);
	chSC1905_Set_Duty_Cycle_Feedback->Connect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Duty_Cycle_Feedback), NULL, this);
	chSC1905_Set_Adaptation_State->Connect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Adaptation_State), NULL, this);
	chSC1905_Set_Correction_Enable->Connect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Correction_Enable), NULL, this);
	btnSC1905_Clear_Warnings->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Clear_Warnings), NULL, this);
	btnSC1905_Set_Cal_Param_A->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Set_Cal_Param_A), NULL, this);
	btnSC1905_Set_Cal_Param_B->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Set_Cal_Param), NULL, this);
	btnSC1905_Clear_Cal_Param->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Clear_Cal_Param), NULL, this);
	btnSC1905_Calibrate_RFIN_PMU->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Calibrate_RFIN_PMU), NULL, this);
	btnSC1905_Calibrate_RFFB_PMU->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Calibrate_RFFB_PMU), NULL, this);
	chSC1905_Guard_Band->Connect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Guard_Band), NULL, this);
	rbtnSC1905_EEPROM_Write->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbtnSC1905_EEPROM_Write), NULL, this);
	rbtnSC1905_EEPROM_Read->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbtnSC1905_EEPROM_Read), NULL, this);
...
{
	// Disconnect Events
	this->Disconnect(wxEVT_CLOSE_WINDOW, wxCloseEventHandler(LMS8FE_view::OnClose_LMS8FE_view));
	rbI2C->Disconnect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbI2CrbUSB), NULL, this);
	rbUSB->Disconnect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbI2CrbUSB), NULL, this);
	btnRefreshPorts->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnRefreshPorts), NULL, this);
	btnOpenPort->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnOpenPort), NULL, this);
	btnClosePort->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnClosePort), NULL, this);
	btnOpen->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnOpen), NULL, this);
	btnSave->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSave), NULL, this);
	btnReset->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnReset), NULL, this);
	btnBoard2GUI->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnReadData), NULL, this);
	cmbChannel->Disconnect(wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	pnlChannel->Disconnect(wxEVT_ERASE_BACKGROUND, wxEraseEventHandler(LMS8FE_view::OnEraseBackground_pnlChannel), NULL, this);
	cbBP_AMPX->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnSimpleChanged), NULL, this);
	...
	cbLMS8001_2_SSENn->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	cbEXT_PLL_SSENn->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	cbLMS8001_1_RESETn->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(LMS8FE_view::OnDetailedChange), NULL, this);
	...
	btnSC1905_Force_Update->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Force_Update), NULL, this);
	btnSC1905_Reset_RFPAL->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Reset_RFPAL), NULL, this);
	txtCtrlSC1905_RFIN_Offset->Disconnect(wxEVT_KILL_FOCUS, wxFocusEventHandler(LMS8FE_view::OnKillFocustxtCtrlSC1905_RFIN_Offset), NULL, this);
	txtCtrlSC1905_RFFB_Offset->Disconnect(wxEVT_KILL_FOCUS, wxFocusEventHandler(LMS8FE_view::OnKillFocustxtCtrlSC1905_RFFB_Offset), NULL, this);
	txtCtrlSC1905_RFFB_Offset->Disconnect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(LMS8FE_view::OntxtCtrlSC1905_RFFB_Offset), NULL, this);
	chSC1905_Frequency_Range->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Frequency_Range), NULL, this);
	btnSC1905_Apply_Frequency->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Apply_Frequency), NULL, this);
	chSC1905_Set_Duty_Cycle_Feedback->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Duty_Cycle_Feedback), NULL, this);
	chSC1905_Set_Adaptation_State->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Adaptation_State), NULL, this);
	chSC1905_Set_Correction_Enable->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Set_Correction_Enable), NULL, this);
	btnSC1905_Clear_Warnings->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Clear_Warnings), NULL, this);
	btnSC1905_Set_Cal_Param_A->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Set_Cal_Param_A), NULL, this);
	btnSC1905_Set_Cal_Param_B->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Set_Cal_Param), NULL, this);
	btnSC1905_Clear_Cal_Param->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Clear_Cal_Param), NULL, this);
	btnSC1905_Calibrate_RFIN_PMU->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Calibrate_RFIN_PMU), NULL, this);
	btnSC1905_Calibrate_RFFB_PMU->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LMS8FE_view::OnbtnSC1905_Calibrate_RFFB_PMU), NULL, this);
	chSC1905_Guard_Band->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler(LMS8FE_view::OnchSC1905_Guard_Band), NULL, this);
	rbtnSC1905_EEPROM_Write->Disconnect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbtnSC1905_EEPROM_Write), NULL, this);
	rbtnSC1905_EEPROM_Read->Disconnect(wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler(LMS8FE_view::OnrbtnSC1905_EEPROM_Read), NULL, this);
